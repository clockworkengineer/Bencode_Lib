# Contributing to Bencode_Lib

Thank you for your interest in contributing to Bencode_Lib! We welcome bug reports, feature requests, and pull requests.
...
5. **Ensure all tests pass** and the project builds cleanly with no warnings (use `-DBENCODE_WARNINGS_AS_ERRORS=ON`).

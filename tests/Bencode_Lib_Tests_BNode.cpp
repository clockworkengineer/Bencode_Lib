...
TEST_CASE("Check use of BNode assigment operators.",
  ...
  //     REQUIRE_FALSE(!BRef<Integer>(bNode).is<float>());
  //     REQUIRE_FALSE(!equalFloatingPoint(BRef<Integer>(bNode).value<float>(),
  //     777.999f, 0.0001));
  //   }
  ...
  //     bNode = 66666.8888;
  //     REQUIRE_FALSE(!bNode.isNumber());
  //     REQUIRE_FALSE(!BRef<Integer>(bNode).is<double>());
  //     REQUIRE_FALSE(!equalFloatingPoint(BRef<Integer>(bNode).value<double>(),
  //     66666.8888, 0.0001));
  //   }
  ...
  //     bNode = 66666.8888l;
  //     REQUIRE_FALSE(!bNode.isNumber());
  //     REQUIRE_FALSE(!BRef<Integer>(bNode).is<long double>());
  //     REQUIRE_FALSE(!equalFloatingPoint(BRef<Integer>(bNode).value<long
